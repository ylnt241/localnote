    ...
    <div className="flex flex-col h-full bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
      ...
      <main className="flex-1 flex overflow-hidden">
        <div className="w-1/2 border-r border-gray-200 flex flex-col flex-shrink-0 min-w-0">
          <div className="px-5 py-2.5 border-b border-gray-200 bg-gray-50 text-xs font-medium text-gray-500 flex-shrink-0">
            Editor
          </div>
          <div className="flex-1 overflow-auto flex-shrink-0 min-w-0">
